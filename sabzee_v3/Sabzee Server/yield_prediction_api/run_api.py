...
def main():
    print("Starting Yield Prediction API...")
    ...
    try:
        ...
        print("Continuing anyway as the API will fall back to feature-based prediction if needed.")
    ...
    # Run the Flask app
    try:
        print("\nStarting the Yield Prediction Flask API...")
